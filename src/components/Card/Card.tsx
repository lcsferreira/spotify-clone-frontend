...
export default function Card({ title, author, img }: CardProps) {
  return (
    <button className="bg-zinc-800/35 p-8 shadow-md w-full shadow-zinc-900 rounded-md flex flex-col justify-evenly gap-4 place-items-center hover:bg-zinc-800 transition ease-linear duration-300">
      <img
        src={img}
        alt={title}
